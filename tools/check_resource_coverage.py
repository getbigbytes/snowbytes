...
import snowbytes
import snowbytes.data_provider
from snowbytes import Resource
...
def check_resource_coverage():
    ...
    for resource in sorted_resources:
        ...
        has_fetch = hasattr(snowbytes.data_provider, f"fetch_{resource_label}")
        has_tests = f"test_fetch_{class_label}" in test_fetch_file
        has_docs = class_label in DOCS
        has_list = hasattr(snowbytes.data_provider, f"list_{pluralize(resource_label)}")
