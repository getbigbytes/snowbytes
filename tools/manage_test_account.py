...
from snowbytes.blueprint_config import print_blueprint_config
from snowbytes.data_provider import fetch_session
from snowbytes.enums import AccountEdition, AccountCloud, ResourceType
from snowbytes.gitops import collect_blueprint_config, collect_vars_from_environment, merge_configs, read_config
...
def reset_test_account():
    ...
    snowbytes_vars = collect_vars_from_environment()
    blueprint_config = collect_blueprint_config(config, {"vars": snowbytes_vars})
