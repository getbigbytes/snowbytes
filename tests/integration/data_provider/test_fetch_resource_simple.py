...
from snowbytes.enums import AccountCloud
from snowbytes.resources import Resource
from snowbytes.scope import AccountScope, DatabaseScope, SchemaScope
...
def resource_fixtures() -> list:
    return [
        ...
        res.User(
            name="TEST_FETCH_USER@getbigbytes.com",
            owner=TEST_ROLE,
            type="PERSON",
            password="hunter2",
