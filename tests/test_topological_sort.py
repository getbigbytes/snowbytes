from snowbytes.blueprint import topological_sort

resource_set = {
    'urn:::role_grant/private_equity_associate?user="c.black@arrakisinvestments.com"',
    "urn:::account/SNOWBYTES_TEST_AWS_ENTERPRISE",
...
refs = [
    ...
    ("urn:::role/private_equity_associate", "urn:::account/SNOWBYTES_TEST_AWS_ENTERPRISE"),
    ('urn:::user/"c.black@arrakisinvestments.com"', "urn:::account/SNOWBYTES_TEST_AWS_ENTERPRISE"),
]
