...
from snowbytes.data_types import convert_to_simple_data_type
...
class NamedResource:
    ...
    without a bunch of user-land cruft to make it all work. This keeps snowbytes close to the behavior
    of snowflake.
